                ...
                <div className="flex flex-wrap justify-center gap-4 mt-8">
                    ...
                    {hackathon.url && (
                        <a
                            ...
                            className="px-5 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-full font-semibold text-sm shadow-lg shadow-emerald-500/30 transition-all flex items-center gap-2 hover:-translate-y-0.5"
                        >
                    ...
                    {teams.map(team => (
                        <div key={team.id} className="group flex flex-col bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border border-gray-100 dark:border-gray-700">
                            ...
                            <div className="mb-4 flex flex-col gap-2 text-sm text-gray-500 dark:text-gray-400">
                                <span className="flex items-center gap-1.5 text-xs font-semibold bg-gray-50 dark:bg-gray-900 px-2 py-1.5 rounded border dark:border-gray-700 w-fit">
                                ...
                                {team.member_names && (
                                    <div className="flex flex-wrap gap-2 mt-1">
                                        {team.member_names.split(',').map((name, i) => (
                                            <span key={i} className="text-gray-600 dark:text-gray-300 font-medium text-xs bg-gray-100 dark:bg-gray-700 px-2 py-0.5 rounded">
                                                {name}
                                            </span>
                                        ))}
                                    </div>
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
                    <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-2xl">
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <button onClick={() => { setManagingTeam(null); setEditingTeam(null); }} className="text-gray-500 hover:text-gray-700 text-xl">
